            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('receber.index')}}">Contas a Receber</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form class="form-inline mb-4" method="GET" action="{{route('rel.movimentacoes')}}" target="_blank">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="btn-salvar-perfil" id="btn-salvar-perfil" class="btn btn-primary">Gerar Relatório</button>
                </form>
            </div>
            </form>
