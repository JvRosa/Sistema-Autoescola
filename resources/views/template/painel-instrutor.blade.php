...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                href="{{route('painel-instrutor.index')}}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="" data-toggle="modal" data-target="#relMov"
                            target="_blank">Comissões</a>
    ...
    <div class="modal fade" id="ModalPerfil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="form-perfil" method="POST" action="{{route('painel-instrutor.editar', $id_usuario)}}">
                    @csrf
                    @method('put');
    ...
    <!--  Modal Comissao Rel  -->
    <div class="modal fade" id="relMov" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="form-inline mb-4" method="GET" action="{{route('rel.comissoes')}}" target="_blank">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <input value="{{$hoje}}" class="form-control mr-sm-2" name="dataInicial" type="date">

                            </div>
                            <div class="col-md-6">
                                <input value="{{$hoje}}" class="form-control mr-sm-2" name="dataFinal" type="date">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-fechar" class="btn btn-secondary"
                        data-dismiss="modal">Cancelar</button>
                    <button type="submit" name="btn-salvar-perfil" id="btn-salvar-perfil" class="btn btn-primary">Gerar
                        Relatório</button>
                    </form>
                </div>
                </form>
